...
import "../styles/pageStyles/restaurant.css"; // Import CSS
        ...
        {restaurants.length === 0 ? (
          ...
          <>
            <div className="text-center text-white">
              No restaurants found from API. Here are some common locations
              while we fix the bug:
            </div>
            <main className="map-container">
              <MinneapolisMap mode="restaurants" />
            </main>
          </>
        ) : (
              ...
              <div key={index} className="col-md-6 col-lg-4 mb-4">
                <div className="card restaurant-card">
                  ...
                  <div className="card-body">
                    ...
                    <p
                      className={`status ${restaurant.business_status.toLowerCase()}`}
                    >
